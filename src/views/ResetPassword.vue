<template class="login">
  <div class="login">
    <OutView title="Reset password" :isBack="true" />
    <div class="login-bd">
      <div>
        <Input type="password" placeholder="Enter your old password" objkey="oldpassword" v-model:formData="loginForm" iconuser="icon-q05" :hasIcon="true" maxLen="10" />
      </div>
      <div>
      ...
      <div class="login-btn-wrap">
        <Button btnText="Save" theme="primary" class="tipBtn" @click="handleSubmit" />
      </div>
    </div>
