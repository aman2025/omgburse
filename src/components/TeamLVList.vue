...
.LVList .item .NumberOfPeople .text2 {
  position: absolute;
  top: 2.3vw;
  left: 77.5vw;
  font-size: 43px;
}
.LVList .item .Details .button {
  width: 80px;
  height: 27px;
  background: #a12740;
  position: absolute;
